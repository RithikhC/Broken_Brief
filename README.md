...
## The brief was broken on purpose. Here's what we did about it.

The brief contradicts itself twice, goes quiet in three places, and then changes
product halfway through. Reading it charitably, the client wants **one thing**:

> *"Help me have a nice day out, without making me think."*

Everything below follows from that. The full reasoning is in **[DECISIONS.md](DECISIONS.md)** —
that's the document to read if you only read one.
